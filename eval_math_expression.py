...
if __name__ == '__main__':
    ...
    assert calc('13 * 36 / 5 / -76 * 71 - 70 * -21 - -80')
    assert calc('-7 * -(6 / 3)') == 14
    assert calc('(2 / (2 + 3.33) * 4) - -6') == 7.50093808630394
    assert calc('(2+2) + (3-3)')
    # assert calc('-7 * -(6 / 3)') == 14
    assert calc('(2 / (2 + 3.33) * 4) - -6*(2+(3-1))') == 7.50093808630394
    '(2/ a * 4) -- 6*(b)'

    assert calc('-(-(-(-1)))')
    assert calc('(((((-1)))))')

    assert calc('-(22) * (-14 / 32 + (52)) - (-12 + (((-(23 / 74)))) + 50)')
